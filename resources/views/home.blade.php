            ...
            @if(Auth::user())
                @if(!empty(Auth::user()->role_id) && Auth::user()->role_id == 1)
                    <div>
                        ...
                        <a href="/measures" class="btn btn-success btn-lg btn-block">Click to see your measurements!</a>
                    </div>
                @elseif(!empty(Auth::user()->role_id) && Auth::user()->role_id == 2)
                    <div>
                        <span style="text-align: center;"><h3>Manage your patients</h3></span>
                        <a href="/patients" class="btn btn-success btn-lg btn-block">Click to see your patients!</a>
                    </div>
                @endif
           @else
            ...
            <div style="margin-top: 30px;">
                <span style="text-align: center;"><h3>Want to know more about project?</h3></span>
                <a href="/about" class="btn btn-primary btn-lg btn-block">Read about project here!</a>
            </div>
        </div>
    </div>
@endsection
